// <copyright file="EncryptedJsonSaver.cs" company="GreedyGuppyGames">
...
namespace Core.Data
{
    ...
    public class EncryptedJsonSaver<T> : JsonSaver<T> where T : IDataStore
    {
        ...
        {
            var underlyingStream = new FileStream(this.m_Filename, FileMode.Create);
        ...
        {
            var underlyingStream = new FileStream(this.m_Filename, FileMode.Open);
