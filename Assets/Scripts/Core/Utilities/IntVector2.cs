// <copyright file="IntVector2.cs" company="GreedyGuppyGames">
...
namespace Core.Utilities
{
    ...
    public struct IntVector2 : IEquatable<IntVector2>
    {
        ...
        {
            get { return Mathf.Abs(this.x) + Mathf.Abs(this.y); }
        }
        ...
        public override int GetHashCode()
        {
            unchecked
            {
                return (this.x.GetHashCode() * 92821) ^ (this.y.GetHashCode() * 31);
            }
        }
