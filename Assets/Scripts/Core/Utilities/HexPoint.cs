// <copyright file="HexPoint.cs" company="GreedyGuppyGames">
...
namespace Core.Utilities
{
    ...
    public struct HexPoint : IEquatable<HexPoint>
    {
        ...
        {
            get { return (Mathf.Abs(this.x) + Mathf.Abs(this.y) + Mathf.Abs(this.z)) / 2; }
        }
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj is HexPoint && this.Equals((HexPoint)obj);
        }
        ...
        public override int GetHashCode()
        {
            unchecked
            {
                return (this.x.GetHashCode() * 22447) ^ (this.y.GetHashCode() * 31);
            }
        }
