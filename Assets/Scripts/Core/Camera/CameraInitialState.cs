// <copyright file="CameraInitialState.cs" company="GreedyGuppyGames">
...
namespace Core.Camera
{
    ...
    public class CameraInitialState : MonoBehaviour
    {
        ...
        {
            var rig = this.GetComponent<CameraRig>();

            switch (this.startZoomMode)
            {
            ...
            if (this.initialLookAt != null)
            {
                rig.PanTo(this.initialLookAt.transform.position);
            }
        }
    }
}