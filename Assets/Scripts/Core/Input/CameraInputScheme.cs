// <copyright file="CameraInputScheme.cs" company="GreedyGuppyGames">
...
namespace Core.Input
{
    ...
    public abstract class CameraInputScheme : InputScheme
    {
        ...
        {
            return this.cameraRig != null ?
                Mathf.Lerp(this.nearZoomPanSpeedModifier, 1, this.cameraRig.CalculateZoomRatio()) :
                1.0f;
        }
        ...
        protected void PanWithScreenCoordinates(Vector2 screenPosition, float screenEdgeThreshold, float panSpeed)
        {
            ...
            if ((screenPosition.x < screenEdgeThreshold))
            {
                ...
                if (this.cameraRig.trackingObject == null)
                {
                    this.cameraRig.PanCamera(Vector3.left * Time.deltaTime * panSpeed * panAmount * zoomRatio);
            ...
            if ((screenPosition.x > Screen.width - screenEdgeThreshold))
            {
                ...
                if (this.cameraRig.trackingObject == null)
                {
                    this.cameraRig.PanCamera(Vector3.right * Time.deltaTime * panSpeed * panAmount * zoomRatio);
                }
            ...
            if ((screenPosition.y < screenEdgeThreshold))
            {
                ...
                if (this.cameraRig.trackingObject == null)
                {
                    this.cameraRig.PanCamera(Vector3.back * Time.deltaTime * panSpeed * panAmount * zoomRatio);
            ...
            if ((screenPosition.y > Screen.height - screenEdgeThreshold))
            {
                ...
                if (this.cameraRig.trackingObject == null)
                {
                    this.cameraRig.PanCamera(Vector3.forward * Time.deltaTime * panSpeed * panAmount * zoomRatio);
