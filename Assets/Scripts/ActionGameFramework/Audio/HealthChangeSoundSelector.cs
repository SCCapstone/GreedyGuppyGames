// <copyright file="HealthChangeSoundSelector.cs" company="GreedyGuppyGames">
...
namespace ActionGameFramework.Audio
{
    ...
    public class HealthChangeSoundSelector
    {
        ...
        public bool isSetUp
        {
            get { return this.healthChangeSounds.Count > 0; }
        }
        ...
        {
            int count = this.healthChangeSounds.Count;

            for (int i = 0; i < count; i++)
            {
                HealthChangeSound sound = this.healthChangeSounds[i];
