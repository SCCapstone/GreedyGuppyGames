// <copyright file="SuperTowerLauncher.cs" company="GreedyGuppyGames">
...
namespace TowerDefense.Towers.TowerLaunchers
{
    ...
    public class SuperTowerLauncher : HomingLauncher
    {
        ...
        public override void Launch(List<Targetable> enemies, GameObject attack, Transform[] firingPoints)
        {
            ...
            Transform firingPoint = this.GetRandomTransform(firingPoints);
            this.Launch(enemy, poolable.gameObject, firingPoint);
        }
        ...
        protected virtual void OnEnable()
        {
            ...
            {
                this.m_LifeTimer = new Timer(this.towerLifeSpan, this.OnLifeTimerElapsed);
            }
            else
            {
        ...
        {
            if (this.m_LifeTimer == null)
            {
                return;
            }

            this.m_LifeTimer.Tick(Time.deltaTime);
        }
