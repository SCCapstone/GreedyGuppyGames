// <copyright file="GameManager.cs" company="GreedyGuppyGames">
...
namespace TowerDefense.Game
{
    ...
    public class GameManager : GameManagerBase<GameManager, GameDataStore>
    {
        ...
        {
            if (!this.levelList.ContainsKey(levelId))
            {
                Debug.LogWarningFormat("[GAME] Cannot complete level with id = {0}. Not in level list", levelId);
                return;
            }

            this.m_DataStore.CompleteLevel(levelId, starsEarned);
            this.SaveData();
        }
        ...
        public LevelItem GetLevelForCurrentScene()
        {
            ...
            return this.levelList.GetLevelByScene(sceneName);
        }
        ...
        public bool IsLevelCompleted(string levelId)
        {
            ...
            return this.m_DataStore.IsLevelCompleted(levelId);
        }
        ...
        public int GetStarsForLevel(string levelId)
        {
            ...
            return this.m_DataStore.GetNumberOfStarForLevel(levelId);
        }
    }
}