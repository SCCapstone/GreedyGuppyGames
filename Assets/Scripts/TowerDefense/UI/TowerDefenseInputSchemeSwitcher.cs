// <copyright file="TowerDefenseInputSchemeSwitcher.cs" company="GreedyGuppyGames">
...
namespace TowerDefense.UI
{
    ...
    public class TowerDefenseInputSchemeSwitcher : InputSchemeSwitcher
    {
        ...
        protected virtual void Start()
        {
            ...
            {
                GameUI.instance.stateChanged += this.OnUIStateChanged;
            }
        }
        ...
        private void OnUIStateChanged(State oldState, State newState)
        {
            ...
            {
                this.m_CurrentScheme.Deactivate(null);
            }
            else
            {
                this.m_CurrentScheme.Activate(null);
            }
        }
    }
}