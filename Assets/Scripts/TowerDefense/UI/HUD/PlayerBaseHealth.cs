// <copyright file="PlayerBaseHealth.cs" company="GreedyGuppyGames">
...
namespace TowerDefense.UI.HUD
{
    ...
    public class PlayerBaseHealth : MonoBehaviour
    {
        ...
        protected void UpdateDisplay()
        {
            ...
            this.display.text = currentHealth.ToString(CultureInfo.InvariantCulture);
        }
    }
}