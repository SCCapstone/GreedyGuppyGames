// <copyright file="EndGameScreen.cs" company="GreedyGuppyGames">
...
namespace TowerDefense.UI
{
    ...
    public class EndGameScreen : MonoBehaviour
    {
        ...
        protected void Start()
        {
            ...
            this.m_LevelManager.levelCompleted += this.Victory;
            this.m_LevelManager.levelFailed += this.Defeat;
        }
        ...
        protected void OpenEndGameScreen(string endResultText)
        {
            ...
            this.endGameCanvas.enabled = true;

            int score = this.CalculateFinalScore();
            this.scorePanel.SetStars(score);
            if (level != null)
            {
                this.endGameMessageText.text = string.Format(endResultText, level.name.ToUpper());
            ...
            else
            {
                ...
                this.endGameMessageText.text = string.Format(endResultText, levelName.ToUpper());
            }
        ...
        {
            this.OpenEndGameScreen(this.levelCompleteText);
            if ((this.victorySound != null) && (this.audioSource != null))
            {
                this.audioSource.PlayOneShot(this.victorySound);
            }

            this.background.color = this.winBackgroundColor;

            // first check if there are any more levels after this one
            if (this.nextLevelButton == null || !GameManager.instanceExists)
            {
                return;
            }
        ...
        {
            this.OpenEndGameScreen(this.levelFailedText);
            ...
            if ((this.defeatSound != null) && (this.audioSource != null))
            {
                this.audioSource.PlayOneShot(this.defeatSound);
            }

            this.background.color = this.loseBackgroundColor;
        }
        ...
        {
            if ((this.m_LevelManager == null) && LevelManager.instanceExists)
            {
        ...
        {
            int homeBaseCount = this.m_LevelManager.numberOfHomeBases;
            PlayerHomeBase[] homeBases = this.m_LevelManager.playerHomeBases;
            ...
            int score = this.CalculateScore(totalRemainingHealth, totalBaseHealth);
            return score;
        }
